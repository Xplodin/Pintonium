...
public class OpenSimplex2S implements INoiseLibrary {
   ...
   private double noise2_Base(double xs, double ys) {
      ...
      double ysi = ys - ysb;
      int a = (int)(xsi + ysi);
      int index = a << 2 | (int)(xsi - ysi / 2.0 + 1.0 - a / 2.0) << 3 | (int)(ysi - xsi / 2.0 + 1.0 - a / 2.0) << 4;
   ...
   public float GetNoise(float x, float y, float z) {
      x = (float)(x * this.frequency);
      y = (float)(y * this.frequency);
      z = (float)(z * this.frequency);
      float sum = 1.0F - (float)Math.abs(this.noise3_XZBeforeY(x, y, z));
      float amp = 1.0F;

      for (int i = 1; i < this.octaves; i++) {
         x = (float)(x * this.lacunarity);
         y = (float)(y * this.lacunarity);
         z = (float)(z * this.lacunarity);
         amp = (float)(amp * this.gain);
         sum -= (1.0F - (float)Math.abs(this.noise3_XZBeforeY(x, y, z))) * amp;
      }
   ...
   static {
      for (int i = 0; i < 8; i++) {
         ...
         LOOKUP_2D[i * 4 + 0] = new OpenSimplex2S.LatticePoint2D(0, 0);
      ...
      OpenSimplex2S.Grad2[] grad2 = new OpenSimplex2S.Grad2[]{
         ...
         new OpenSimplex2S.Grad2(0.793353340291235, 0.608761429008721),
         new OpenSimplex2S.Grad2(0.923879532511287, 0.38268343236509),
         new OpenSimplex2S.Grad2(0.99144486137381, 0.130526192220051),
         new OpenSimplex2S.Grad2(0.99144486137381, -0.130526192220051),
         new OpenSimplex2S.Grad2(0.923879532511287, -0.38268343236509),
         new OpenSimplex2S.Grad2(0.793353340291235, -0.60876142900872),
         new OpenSimplex2S.Grad2(0.608761429008721, -0.793353340291235),
         new OpenSimplex2S.Grad2(0.38268343236509, -0.923879532511287),
         new OpenSimplex2S.Grad2(0.130526192220052, -0.99144486137381),
         new OpenSimplex2S.Grad2(-0.130526192220052, -0.99144486137381),
         ...
         new OpenSimplex2S.Grad2(-0.793353340291235, -0.608761429008721),
         new OpenSimplex2S.Grad2(-0.923879532511287, -0.38268343236509),
         new OpenSimplex2S.Grad2(-0.99144486137381, -0.130526192220052),
         new OpenSimplex2S.Grad2(-0.99144486137381, 0.130526192220051),
         new OpenSimplex2S.Grad2(-0.923879532511287, 0.38268343236509),
         new OpenSimplex2S.Grad2(-0.793353340291235, 0.608761429008721),
         new OpenSimplex2S.Grad2(-0.608761429008721, 0.793353340291235),
      ...
      for (int i = 0; i < grad2.length; i++) {
         grad2[i].dx /= 0.05481866495625118;
         grad2[i].dy /= 0.05481866495625118;
      }
      ...
      OpenSimplex2S.Grad3[] grad3 = new OpenSimplex2S.Grad3[]{
         new OpenSimplex2S.Grad3(-2.22474487139, -2.22474487139, -1.0),
         new OpenSimplex2S.Grad3(-2.22474487139, -2.22474487139, 1.0),
         new OpenSimplex2S.Grad3(-3.0862664687972017, -1.1721513422464978, 0.0),
         new OpenSimplex2S.Grad3(-1.1721513422464978, -3.0862664687972017, 0.0),
         new OpenSimplex2S.Grad3(-2.22474487139, -1.0, -2.22474487139),
         new OpenSimplex2S.Grad3(-2.22474487139, 1.0, -2.22474487139),
         new OpenSimplex2S.Grad3(-1.1721513422464978, 0.0, -3.0862664687972017),
         new OpenSimplex2S.Grad3(-3.0862664687972017, 0.0, -1.1721513422464978),
         new OpenSimplex2S.Grad3(-2.22474487139, -1.0, 2.22474487139),
         new OpenSimplex2S.Grad3(-2.22474487139, 1.0, 2.22474487139),
         new OpenSimplex2S.Grad3(-3.0862664687972017, 0.0, 1.1721513422464978),
         new OpenSimplex2S.Grad3(-1.1721513422464978, 0.0, 3.0862664687972017),
         ...
         new OpenSimplex2S.Grad3(-1.1721513422464978, 3.0862664687972017, 0.0),
         new OpenSimplex2S.Grad3(-3.0862664687972017, 1.1721513422464978, 0.0),
         new OpenSimplex2S.Grad3(-1.0, -2.22474487139, -2.22474487139),
         new OpenSimplex2S.Grad3(1.0, -2.22474487139, -2.22474487139),
         new OpenSimplex2S.Grad3(0.0, -3.0862664687972017, -1.1721513422464978),
         new OpenSimplex2S.Grad3(0.0, -1.1721513422464978, -3.0862664687972017),
         new OpenSimplex2S.Grad3(-1.0, -2.22474487139, 2.22474487139),
         new OpenSimplex2S.Grad3(1.0, -2.22474487139, 2.22474487139),
         new OpenSimplex2S.Grad3(0.0, -1.1721513422464978, 3.0862664687972017),
         new OpenSimplex2S.Grad3(0.0, -3.0862664687972017, 1.1721513422464978),
