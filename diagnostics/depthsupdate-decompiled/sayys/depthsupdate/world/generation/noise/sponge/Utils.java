...
public final class Utils {
   public static final double[] RANDOM_VECTORS = new double[]{
      -0.763874,
      -0.596439,
      -0.246489,
      0.0,
   ...
   public static double makeInt32Range(double n) {
      if (n >= 1.0737418E9F) {
         return 2.0 * n % 1.0737418E9F - 1.0737418E9F;
      } else {
         return n <= -1.0737418E9F ? 2.0 * n % 1.0737418E9F + 1.0737418E9F : n;
      }
   }
   ...
   static {
      for (int i = 0; i < RANDOM_VECTORS.length; i++) {
         double[] var10000 = RANDOM_VECTORS;
         var10000[i] /= 2.0 * Math.sqrt(3.0);
      }
   }
}
