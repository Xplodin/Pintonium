   ...
   public double getValue(double x, double y, double z) {
      if (this.sourceModule[0] == null) {
         ...
         if (size < 4) {
            ...
            while (indexPos < size && !(sourceModuleValue < this.controlPoints.get(indexPos).inputValue)) {
               indexPos++;
            }
            ...
            if (index1 == index2) {
               ...
               double input0 = this.controlPoints.get(index1).inputValue;
               double input1 = this.controlPoints.get(index2).inputValue;
