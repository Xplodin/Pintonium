...
public class AmethystRegistry {
   public static final Block amethyst_block = new BlockDeepslateVariant("amethyst_block", 1.5F, 1.5F, SoundType.field_185853_f);
   ...
   public static final Item amethyst_shard = ((Item)new Item().setRegistryName("depthsupdate", "amethyst_shard"))
      .func_77655_b("amethyst_shard")
      .func_77637_a(CreativeTabs.field_78035_l);
   public static final RegistrationFeature AMETHYST_FEATURE = new RegistrationFeature(() -> DepthsUpdateConfig.REGISTRY.enableAmethystFamily)
      .add(amethyst_block, budding_amethyst, small_amethyst_bud, medium_amethyst_bud, large_amethyst_bud, amethyst_cluster, amethyst_shard);
}
