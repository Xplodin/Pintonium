...
public final class CompatConfig {
   ...
   public static synchronized void reload() {
      ...
      try {
         ...
         System.err.println("[BCDU Compat] Failed to read " + CONFIG_FILE + ": " + var6.getMessage());
         return;
      }
   ...
   private static void ensureExists() {
      if (!CONFIG_FILE.isFile()) {
         ...
         if (var0 != null && !var0.isDirectory() && !var0.mkdirs()) {
            System.err.println("[BCDU Compat] Could not create config directory: " + var0);
         } else {
            try {
               ...
               System.err.println("[BCDU Compat] Failed to create default config: " + var6.getMessage());
            }
         }
      }
   }
      ...
      if (!var1.equalsIgnoreCase("all") && !var1.equals("*")) {
         ...
         for (String var6 : var1.split(",")) {
            try {
               ...
               System.err.println("[BCDU Compat] Ignoring invalid dimension ID: " + var6);
            }
         }
